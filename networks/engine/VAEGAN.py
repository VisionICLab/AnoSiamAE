...
from networks.loss.regularizer import KLLoss
from networks.loss.reconstruction import MSELoss
import networks.models.builder as builder
from .base import _BaseModel
from .build import MODEL_REGISTRY

@MODEL_REGISTRY.register("VAEGAN")
class VAEGANTrainer(_BaseModel):
    def __init__(self, cfg, device="cuda", ckpt_path=None):
        super().__init__(cfg, device)
        # Critic
        self.critic = builder.__dict__["build_"+cfg.CRITIC.NAME](cfg.CRITIC, device)
