...
class Discriminator(nn.Module):
    ...
    def __init__(self, in_shape=(3,256,256), num_channels = (64, 128, 256, 512,1024,2048), dropout=0.0, num_groups=8, norm="batch", patch_disc=False):
...
def build_model(params,device="cuda"):
    model = Discriminator(in_shape= params.IN_SHAPE,num_channels = params.NUM_CHANNELS, dropout=params.DROPOUT, num_groups=params.NUM_GROUPS,
                          norm=params.NORM, patch_disc=params.PATCH).to(device)
    return model
